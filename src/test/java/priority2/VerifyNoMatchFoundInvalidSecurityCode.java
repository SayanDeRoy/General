...
public class VerifyNoMatchFoundInvalidSecurityCode {
	
	WebDriver driver;
	Base base = new Base();
	int invalidSecurityCode = 56014789;
	...
	public void verifyNoMatchFound() throws InterruptedException
	{
		...
		String actualText = rcp.enterSecurityCodeAndSelect(invalidSecurityCode, "");
